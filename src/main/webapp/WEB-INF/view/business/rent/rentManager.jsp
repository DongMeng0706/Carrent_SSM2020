...
<body class="childrenBody">
	...
	<script src="${ctx }/resources/js/commonTools.js"></script>
			...
			//渲染数据表格
			 tableIns=table.render({
			    ...
			    ,cols: [[   //列表数据
			      ...
			      ,{field:'begindate', title:'起租时间',align:'center',width:'180',templet:"#begindateshow"}
			      ,{field:'returndate', title:'还车时间',align:'center',width:'180',templet:"#returndateshow"}
			      ,{field:'price', title:'出租价格',align:'center',width:'120'}
			      ,{field:'opername', title:'操作员',align:'center',width:'120'}
			      ,{field:'createtime', title:'录入时间',align:'center',width:'180',templet:"#createTime"}
	...
	<script id="begindateshow" type="text/html">
		{{#
		var date = new Date();
		date.setTime(d.begindate);
		return date.Format("yyyy-MM-dd hh:mm:ss");
		}}
	</script>

	<script id="returndateshow" type="text/html">
		{{#
		var date = new Date();
		date.setTime(d.returndate);
		return date.Format("yyyy-MM-dd hh:mm:ss");
		}}
	</script>
</body>
